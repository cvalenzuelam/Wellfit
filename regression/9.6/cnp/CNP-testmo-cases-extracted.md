...
======================================================================
TC01 | Case 13579 | Validate that, CNP can process successful transactions with VISA Card.
======================================================================
DESCRIPTION:
AC Linked: AC-1
...
======================================================================
TC02 | Case 13580 | Validate that, CNP can process successful transactions with AMEX Card.
======================================================================
DESCRIPTION:
AC Linked: AC-2
...
======================================================================
TC03 | Case 13581 | Validate that,  CNP can process successful transactions with Discover card.
======================================================================
DESCRIPTION:
Preconditions
- {{URL}} points to the environment under test.
...
======================================================================
TC04 | Case 13582 | Validate that, CNP can process successful transactions with MasterCard.
======================================================================
DESCRIPTION:
AC Linked: AC-4
...
======================================================================
TC05 | Case 13583 | Validate that, CNP receives an error message when the CVV does not match.
======================================================================
DESCRIPTION:
AC Linked: AC-5
...
======================================================================
TC06 | Case 13584 | Validate that,  CNP receives an error message when the Zipcode does not match.
======================================================================
DESCRIPTION:
AC Linked: AC-6
...
======================================================================
TC07 | Case 13585 | Validate that,  CNP receives an error message when card is expired
======================================================================
DESCRIPTION:
AC Linked: AC-7
...
======================================================================
TC08 | Case 13586 | Validate that, the correct Transaction Amount is stored in the [Payments].[Payments] DB table.
======================================================================
DESCRIPTION:
AC Linked: AC-8
...
======================================================================
TC09 | Case 13588 | Validate that, the correct PaymenTypeMethod is stored for the new payment transaction in the [Payments].[Payments] DB table
======================================================================
DESCRIPTION:
AC Linked: AC-9
...
======================================================================
TC10 | Case 66733 | Validate that, a partial refund is able to get successfully processed for CNP transaction
======================================================================
DESCRIPTION:
AC Linked: AC-10
...
======================================================================
TC11 | Case 286525 | Validate that,  the correct partial refund Amount and TransactionID is stored in the [Payments].[Refunds] table
======================================================================
DESCRIPTION:
AC Linked: AC-11
...
======================================================================
TC12 | Case 66734 | Validate that, a void transaction (Full refund under the same day window) is able to get successfully processed for CNP transaction
======================================================================
DESCRIPTION:
...
======================================================================
TC13 | Case 286526 | Validate that, the correct void amount and transactionID is stored in the [Payments].[Voids] table
======================================================================
DESCRIPTION:
AC Linked: AC-13
...
======================================================================
TC14 | Case 294866 | Validate that, CNP with Wellfit GUID can process successful transactions with VISA Card.
======================================================================
DESCRIPTION:
AC Linked: AC-14
...
======================================================================
TC15 | Case 294867 | Validate that, CNP with Wellfit GUID can process successful transactions with AMEX Card.
======================================================================
DESCRIPTION:
AC Linked: AC-15
...
======================================================================
TC16 | Case 294868 | Validate that, CNP with Wellfit GUID can process successful transactions with DISCOVER Card.
======================================================================
DESCRIPTION:
AC Linked: AC-16
...
======================================================================
TC17 | Case 294869 | Validate that, CNP with Wellfit GUID can process successful transactions with Master  Card.
======================================================================
DESCRIPTION:
AC Linked: AC-17
