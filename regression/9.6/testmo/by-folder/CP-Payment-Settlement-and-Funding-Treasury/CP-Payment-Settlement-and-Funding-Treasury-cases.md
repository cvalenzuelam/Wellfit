# CP Payment - Settlement and Funding - Treasury
...
## 2. Validate that CP Payment can be successfully sent to the system
...
## 3. Validate that CP transaction is successfully stored as 'Approved' in Payments  DB
...
## 4. Validate that  CP transaction gets "SettlementDate"value filled via query through Payments  DB Table
