...
Preconditions:
ACH transaction statusId should be updated to 6 via SQL so refund can be eligible
 Refund more than 0 and no greater than transaction amount
New Token in paylod and new Idempotency Key in request headers - No duplicate
...
Preconditions:
ACH refund already status 5 Funded, with SettlementDate and FundingInstructionsId
...
The batch Id you get from payments.fundingInstructions 
you can correlate and search in payments.fundingbatches
